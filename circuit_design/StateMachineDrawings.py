...
def t2a(ax, type, num, start, end, prev_end, scale, linewidth, opts):
    # Default parameters
    color = (0,0,0)
    color2 = (0,0,0)
    start_pad = 0.0
    ...
    if opts != None:
        ...
        if 'color2' in list(opts.keys()):
            ...
            if 'color' in list(opts.keys()):
                ...
                color2 = (r2,g2,b2)
    #pdb.set_trace()
    ax.add_patch(patches.Rectangle((start,-y_extent/2),x_extent,y_extent, facecolor=(1,1,1),linewidth=linewidth, edgecolor=(0,0,0), fill=True, zorder=12))
    if opts != None and 'label' in list(opts.keys()):
        zorder_add = 0.0
        label_style = 'italic'
        label_size = 10
        label_color = (0,0,0)
        label_rotation = 0
        ax.text(start+x_extent/2, y_extent, "t2a", horizontalalignment='center',
    ...
    # Return the final start and end positions to the DNA renderer
    return start, start+x_extent+end_pad
        ...
        if "Numb" in name:
            for x in base_colors:
                if x in name:
                    ...
                    break
        if name not in base_colors:
            base_colors[name]=generateLightColor()
...
def grn_dnaplotlib_mapping(seq, highlight_part=None):
    ...
    for element in seq:
        ...
        if 't2a' in element:
            seq_to_plot.append({'type':'t2a', 'name':'t2a', 'fwd':True, "opts":{'label':'t2a', 'label_x_offset':0, 
                                                     'label_y_offset':vertOffset, 'label_rotation':0, 
                                                     'label_style':'italic',
                                                     'label_size':textSize,
                                                     'x_extent':8, 'y_extent':6}})
        elif 'promoter_F' in element:
...
def generateLightColor():
    ...
    while r+g+b<1.8:
        lowest=min(r,g,b)
        if r==lowest:
            r=lowest+(1-lowest)*random.random()
        elif g==lowest:
            g=lowest+(1-lowest)*random.random()
        else:
            b=lowest+(1-lowest)*random.random()
    return (r,g,b)
...
def diagramFromFile(inFile, outFile):
    ...
    numLines=len(sequence)//15
    if len(sequence)%15>0:
        numLines+=1
    width=15
    height=2.5*numLines
    fig = plt.figure(figsize=(width,height))
    ...
    while spot<len(sequence):
        design = grn_dnaplotlib_mapping(sequence[spot:min(spot+15,len(sequence))])
        ax_dna = plt.subplot(gs[count,0])
        start, end = dr.renderDNA(ax_dna, design, part_renderers, regs=None, reg_renderers=None)
        ax_dna.set_xlim([start, end])
        ax_dna.set_ylim([-30,30])
        ax_dna.set_aspect('equal')
        ...
        spot+=15
    fig.savefig(outFile, transparent=False)
    fig.savefig(outFile[:-3]+'png', dpi=300)

    
 
if __name__=='__main__':
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_2state.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_2state.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_5state.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_5state.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_16state.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_16state.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_65state.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_65state.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_326state.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/T_Lu_326state.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan2tetbind_exc.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan2tetbind_exc.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan2tetbind_flipreg.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan2tetbind_flipreg.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristanUniqueOut4Reg.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristanUniqueOut4Reg.pdf")
        
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/7tet_example_register.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/7tet_example_register.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/siteshapetest.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/SiteShapeTest.pdf")
    
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan4count.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan4count.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan2tetbind_exc_numb.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan2tetbind_exc_numb.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/counter_troubleshoot3.csv",
                        "/Users/Tristan/Documents/counter_troubleshoot3.pdf")
        diagramFromFile("/Users/Tristan/Documents/register_troubleshoot3.csv",
                        "/Users/Tristan/Documents/register_troubleshoot3.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan8count.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/tristan8count.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/7tet_lowerD_numb_early.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/7tet_lowerD_numb_early.pdf")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/Cone_Counter.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/Cone_Counter.pdf")
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/Cone_Register.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/circuit_design/examples/Cone_Register.pdf")
    if 0==1:
        diagramFromFile("examples/Lim_Green_Red.csv","examples/Lim_Green_Red.pdf")
    if 0==1:
        diagramFromFile("random/3hetero_5cell_circuits/0homo_3hetero_5cell_ciruit0.csv","random/3hetero_5cell_circuits/0homo_3hetero_5cell_circuit0.png")
    if 0==1:
        diagramFromFile("examples/full_flow_test_circuit.csv","examples/full_flow_test_circuit.png")
    if 0==1:
        diagramFromFile("examples/full_flow_test_circuit_binary.csv","examples/full_flow_test_circuit_binary.png")
    if 0==1:
        diagramFromFile("examples/full_flow_test_big.csv","examples/full_flow_test_big.png")
    if 0==1:
        diagramFromFile("examples/full_flow_tets_linear.csv","examples/full_flow_tets_linear.png")
    if 0==1:
        diagramFromFile("examples/landing_pad.csv","examples/landing_pad.png")
    if 0==1:
        diagramFromFile("examples/test_rod_max_register.csv","test_rod_max_register.png")
        diagramFromFile("examples/test_rod_max_counter.csv","test_rod_max_counter.png")
    if 0==1:
        diagramFromFile("examples/3tet_register.csv","3tet_register.png")
        #diagramFromFile("examples/3tet_counter.csv","3tet_counter.png")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/example_circuits/5Tets_register.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/example_circuits/5Tets_register.png")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/CAD_bio/src/python/example_circuits/5tets_problem.csv",
                        "/Users/Tristan/Documents/CAD_bio/src/python/example_circuits/5tets_problem.png")
    if 0==1:
        diagramFromFile("examples/5Tets_line_register.csv",
                        "examples/5Tets_line_register.png")
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/2019_05_16_circuit_for_gchao.csv","/Users/Tristan/Documents/2019_05_16_circuit_for_gchao.png")
        
    if 0==1:
        diagramFromFile("/Users/Tristan/Documents/2_tet_register.csv","/Users/Tristan/Documents/2_tet_register.png")
    if 1==1:
        diagramFromFile("/Users/Tristan/Dropbox (HMS)/2019_06_04_Lim_register.csv","/Users/Tristan/Dropbox (HMS)/2019_06_04_Lim_register.png")
        diagramFromFile("/Users/Tristan/Dropbox (HMS)/2019_06_04_2tets_register.csv","/Users/Tristan/Dropbox (HMS)/2019_06_04_2tets_register.png")
        diagramFromFile("/Users/Tristan/Dropbox (HMS)/2019_06_04_3tets_register.csv","/Users/Tristan/Dropbox (HMS)/2019_06_04_3tets_register.png")
        diagramFromFile("/Users/Tristan/Dropbox (HMS)/2019_06_04_counter.csv","/Users/Tristan/Dropbox (HMS)/2019_06_04_counter.png")